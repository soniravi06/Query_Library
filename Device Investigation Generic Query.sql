...
Show Suspect Executables ( 1 = TRUE)
Show New Installs ( 1 = TRUE )
Add section headers and dividers ( 1 = TRUE)
Show Device Info ( 1 = TRUE)
Show Live off the land tool info ( 1 = TRUE )
